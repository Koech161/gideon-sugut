      ...
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 gap-12 mb-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            <div className="flex items-center mb-4">
              <div className="flex items-center justify-center w-10 h-10 mr-3 rounded-lg bg-gradient-to-r from-pink-600 to-rose-500">
                <span className="text-lg font-bold text-white">CJ</span>
              </div>
              <h3 className="text-2xl font-bold text-white">
                Caroline <span className="text-pink-400">Jelimo</span>
              </h3>
            </div>
            ...
            <div className="flex space-x-3">
              {contactLinks.map((link) => (
                <motion.a
                  ...
                  className={`w-10 h-10 rounded-lg ${link.color} text-white flex items-center justify-center shadow-lg transition-all duration-300 shadow-pink-900/20`}
            ...
            <div className="space-y-4 text-gray-400">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-pink-400/80">2,400m • Home of Champions</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-1">carolinejelimo22@.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-1">+254 727 114 419</p>
                </div>
              </div>
        ...
        >
          <p className="text-sm text-gray-500">
            © {currentYear} Caroline Jelimo. All rights reserved.
          </p>
          <div className="flex flex-col items-center mt-4 space-y-3 md:mt-0 md:flex-row md:space-y-0 md:space-x-6">
            <p className="text-sm text-gray-500">
              Representing: <span className="text-pink-400">Kenya Prisons • Athletics Kenya</span>
            </p>
            <p className="text-sm text-gray-500">
              Developed by{' '}
              <a 

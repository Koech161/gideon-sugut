...
function TimelineItem({ achievement, index }) {
  ...
  return (
    ...
    >
      {/* Timeline dot */}
      <div className="absolute z-10 hidden w-6 h-6 bg-white border-4 rounded-full border-emerald-500 sm:block left-8 md:left-1/2 md:-translate-x-1/2"></div>
      ...
      <div className="p-8 bg-white border border-gray-100 shadow-lg rounded-2xl">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {achievements.map((achievement) => (
            <div key={achievement.id} className="p-6 border border-emerald-100 rounded-xl bg-gradient-to-br from-emerald-50 to-emerald-100/50">

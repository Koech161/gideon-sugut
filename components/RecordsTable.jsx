...
export default function Achievements() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white to-emerald-50" id="achievements">
      <div className="container px-4 mx-auto">
        ...
        >
          ...
          <h1 className="mb-4 text-4xl font-black text-gray-900 sm:text-5xl">
            Racing <span className="text-emerald-600">Achievements</span>
          </h1>
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="px-3 py-2 text-sm text-gray-800 border rounded-lg border-emerald-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
            >
        ...
        {filteredAchievements.length === 0 && (
          ...
          >
            ...
            <button 
              ...
              className="mt-3 underline transition-colors text-emerald-700 hover:text-emerald-800"
            >
  ...
  return (
    <motion.div
      className={`h-full p-6 border rounded-2xl transition-all hover:shadow-lg ${
        achievement.highlight 
          ? 'bg-gradient-to-br from-emerald-50 to-emerald-100 border-emerald-300 border-l-4' 
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <span className={`inline-block px-3 py-1 text-xs font-semibold rounded-full ${
            achievement.highlight ? 'bg-emerald-500 text-white' : 'bg-emerald-100 text-emerald-800'
          }`}>
      ...
      <p className={`text-sm font-semibold mb-3 ${
        achievement.highlight ? 'text-emerald-700' : 'text-gray-700'
      }`}>
      ...
      <div className="mb-4">
        <div className="flex items-center gap-2 mb-2">
          <span className="text-2xl font-black text-emerald-600">{achievement.time}</span>
          {achievement.highlight && (
            <span className="px-2 py-1 text-xs font-bold text-white rounded-full bg-emerald-500">PB</span>
          )}
        </div>
      ...
      {/* Achievement Badge */}
      {achievement.highlight && (
        <div className="flex items-center justify-between pt-4 mt-4 border-t border-emerald-100">
          <span className="text-xs font-semibold uppercase text-emerald-600">Record Performance</span>
          <div className="flex items-center">
            <div className="w-2 h-2 mr-1 rounded-full bg-emerald-400 animate-pulse"></div>
            <span className="text-xs text-emerald-600">Highlight</span>
          </div>
        </div>
      )}
    </motion.div>

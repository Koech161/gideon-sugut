      ...
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 gap-12 mb-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          >
            <h3 className="mb-4 text-2xl font-black text-white">
              Selly <span className="text-lime-400">Rono</span>
            </h3>
            <p className="mb-6 leading-relaxed text-gray-400">
              World-class Kenyan marathon champion dedicated to excellence, 
        ...
        >
          <p className="mb-4 text-sm text-gray-500 md:mb-0">
            &copy; {new Date().getFullYear()} Selly Jepng'etich Rono. All rights reserved.
          </p>
